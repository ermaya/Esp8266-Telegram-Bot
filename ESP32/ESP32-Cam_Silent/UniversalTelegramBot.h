...
//jz caption
  ...
  bool sendSilentMessage(const String& chat_id, const String& text, const String& parse_mode = "");
  ...
  String userName;
  int longPoll = 0;
  unsigned int waitForResponse = 1000; // ------------------------- era de 1500 -----------------------------------------------
  int _lastError;
  int last_sent_message_id = 0;
  int maxMessageLength = 1500;
  int mp_delay = 0;  // delay between multipart blocks ------------ era 0 -----------------------------------------------------
